...
class Agent():
    def __init__(self, env, epsilon=0.5, learning_rate=0.0002, GAMMA=0.97, batch_size=32, capacity=10000):
        """
...
def test(env):
    ...
    testing_agent.target_net.load_state_dict(torch.load("./Tables/DQN_5500.pt"))
    for epi in range(10):
        ...
        while True:
            ...
            if np.random.rand() < (1-testing_agent.epsilon):
